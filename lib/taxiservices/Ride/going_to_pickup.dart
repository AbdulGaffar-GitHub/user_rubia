...
class NewPickUpRide extends StatefulWidget {
  NewPickUpRide({
    Key? key,
    this.rideData,
  }) : super(key: key);
  ...
  @override
  _NewPickUpRideState createState() => _NewPickUpRideState();
}

class _NewPickUpRideState extends State<NewPickUpRide> {
...
// wrapper around the location API
  ...
  void showPinsOnMap() async {
    ...
    final Uint8List destiIcon =
        await getBytesFromAsset('assets/icons/dropLocation.png', 150);
